...
function generateHeader(doc) {
  doc
    ...
    .fillColor("#444444")
    .fontSize(20)
    .text("Dom' des Landes", 110, 57)
    .fontSize(10)
    .text("Dom' des Landes", 200, 50, { align: "right" })
    .text("123 avenue principale", 200, 65, { align: "right" })
    .text("12345 Ville France", 200, 80, { align: "right" })
    .moveDown();
}
